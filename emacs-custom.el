...
(custom-set-faces
 ...
 '(gnus-header-content-face ((((class color) (background dark)) (:italic t :foreground "green"))))
 '(gnus-header-name-face ((((class color) (background dark)) (:foreground "YellowGreen"))))
 '(gnus-header-subject-face ((((class color) (background dark)) (:foreground "Yellow"))))

...
(custom-set-faces
 ...
 '(org-block-begin-line ((((min-colors 257) (background dark)) (:background "#274949" :foreground "#80af9f" :overline t :weight normal)) (((min-colors 256) (background dark)) (:background "#3a3a3a" :foreground "#80af9f")) (((background light)) (:background "#f5fef5" :foreground "#80af9f"))))
 '(org-block-end-line ((((min-colors 257) (background dark)) (:background "#274949" :foreground "firebrick" :underline t :weight normal)) (((min-colors 256) (background dark)) (:background "#3a3a3a" :foreground "pink4")) (((background light)) (:background "#f5fef5" :foreground "pink4"))))
 ...
 '(outline-4 ((((background dark)) (:foreground "mediumpurple1" :weight bold)) (((background light)) (:foreground "darkcyan" :weight bold))))
 ...
 '(outline-7 ((t (:foreground "plum" :weight bold))))
